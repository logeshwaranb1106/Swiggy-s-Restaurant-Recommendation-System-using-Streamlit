...
@st.cache_data  #speeds thing up by avoiding reloading on every time
...
if st.sidebar.button("✨ Get Recommendations"):
    ...
    if filtered_cleaned_df.empty:
        ...
        user_input = {
            f"city_{city}": 1, # Encoding the selected city in the input vector of one-hot encoding
        ...
        # This part finds the top 5 restaurants most similar to the user's preferences using cosine similarity and shows their key details.
